...
export default function FindFoodBank() {
	...
	const data = [
		...
		},
		{
			...
			availableDays: [, 'Friday- 9:00am - 3:00pm'],
			foodItems: ['noodles', 'spaghetti', 'onions', 'yoghurt'],
			isAccesible: false,
			packageType: 'hampers',
		},
		{
